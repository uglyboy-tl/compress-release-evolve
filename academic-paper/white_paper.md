...
2. The **entropy-leakage principle** — that total entropy does not decrease, only transfers across dimensions — offers a testable diagnostic for why optimizing one dimension often degrades overall system health.
